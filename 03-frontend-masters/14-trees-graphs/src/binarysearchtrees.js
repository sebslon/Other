...
class BinarySearchTree {
  ...
  remove(value) {
    function removeHelper(node, value) {
      if (node.value === value) {
        // No children - remove current node
  ...
  inOrderTraversal(node, func = console.log) {
    ...
    if (node.left !== null) this.inOrderTraversal(node.left, func);
    func(node);
    if (node.right !== null) this.inOrderTraversal(node.right, func);
  }
  ...
  preOrderTraversal(node, func = console.log) {
    ...
    func(node);
    if (node.left !== null) this.preOrderTraversal(node.left, func);
    if (node.right !== null) this.preOrderTraversal(node.right, func);
  }
  ...
  postOrderTraversal(node, func = console.log) {
    ...
    if (node.left !== null) this.postOrderTraversal(node.left, func);
    if (node.right !== null) this.postOrderTraversal(node.right, func);
    func(node);
  }
}
