class BinaryTree {
  ...
  preOrderTraversal(func = console.log) {
    ...
    if (this.left) this.left.preOrderTraversal(func);
    if (this.right) this.right.preOrderTraversal(func);
  }

  // left, right, root
  postOrderTraversal(func = console.log) {
    if (this.left) this.left.postOrderTraversal(func);
    if (this.right) this.right.postOrderTraversal(func);
